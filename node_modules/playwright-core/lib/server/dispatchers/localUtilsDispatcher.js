...
class LocalUtilsDispatcher extends _dispatcher.Dispatcher {
  ...
  async zip(params) {
    return await localUtils.zip(_platform.nodePlatform, this._stackSessions, params);
  }
  ...
  async traceDiscarded(params, metadata) {
    return await localUtils.traceDiscarded(_platform.nodePlatform, this._stackSessions, params);
  }
