...
async function writePreferences(options) {
  ...
  const result = await Promise.allSettled([fs.promises.writeFile(path.join(options.path, 'user.js'), lines.join('\n')),
  // Create a backup of the preferences file if it already exitsts.
  fs.promises.access(prefsPath, fs.constants.F_OK).then(async () => {
    await fs.promises.copyFile(prefsPath, path.join(options.path, 'prefs.js.playwright'));
  },
