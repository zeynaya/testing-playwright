...
class HttpServer {
  ...
  _serveFile(response, absoluteFilePath) {
    ...
    const contentType = _utilsBundle.mime.getType(path.extname(absoluteFilePath)) || 'application/octet-stream';
  ...
  _serveRangeFile(request, response, absoluteFilePath) {
    ...
    response.writeHead(206, {
      ...
      'Content-Type': _utilsBundle.mime.getType(path.extname(absoluteFilePath))
    });
    const readable = fs.createReadStream(absoluteFilePath, {
      start,
      end
    });
