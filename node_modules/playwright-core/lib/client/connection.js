...
class Connection extends _events.EventEmitter {
  constructor(localUtils, platform, instrumentation, headers) {
    super();
  ...
  async sendMessageToServer(object, method, params, apiName, frames, stepId) {
    ...
    _zones.zones.empty().run(() => this.onmessage({
      ...message,
      metadata
    }));
  ...
  dispatch(message) {
    ...
    if (id) {
      ...
      if (error && !result) {
        ...
        (0, _stackTrace.rewriteErrorMessage)(parsedError, parsedError.message + (0, _stackTrace.formatCallLog)(log));
