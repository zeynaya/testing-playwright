...
class BrowserType extends _channelOwner.ChannelOwner {
  ...
  async launch(options = {}) {
    ...
    (0, _debug.assert)(!options.userDataDir, 'userDataDir option is not supported in `browserType.launch`. Use `browserType.launchPersistentContext` instead');
    (0, _debug.assert)(!options.port, 'Cannot specify a port without launching as a server.');
  ...
  async connect(optionsOrWsEndpoint, options) {
    ...
    (0, _debug.assert)(optionsOrWsEndpoint.wsEndpoint, 'options.wsEndpoint is required');
  ...
  async connectOverCDP(endpointURLOrOptions, options) {
    ...
    (0, _debug.assert)(endpointURL, 'Cannot connect over CDP without wsEndpoint.');
