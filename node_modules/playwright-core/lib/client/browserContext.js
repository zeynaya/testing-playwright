    ...
    await this._wrapApiCall(async () => {
      ...
      for (const [harId, harParams] of this._harRecorders) {
        ...
        if (isCompressed && !needCompressed) {
          ...
          await this._connection.localUtils().harUnzip({
...
async function prepareBrowserContextParams(platform, options) {
  ...
  if (contextParams.recordVideo && contextParams.recordVideo.dir) contextParams.recordVideo.dir = platform.path().resolve(process.cwd(), contextParams.recordVideo.dir);
