  ...
  async connect(wsEndpoint, options = {}) {
    return await this._wrapApiCall(async () => {
      ...
      const result = await (0, _timeoutRunner.raceAgainstDeadline)(async () => {
        ...
        device.on(_events2.Events.AndroidDevice.Close, () => connection.close());
        return device;
      }, deadline);
      if (!result.timedOut) {
...
class AndroidDevice extends _channelOwner.ChannelOwner {
  ...
  async waitForEvent(event, optionsOrPredicate = {}) {
    return await this._wrapApiCall(async () => {
      ...
      if (event !== _events2.Events.AndroidDevice.Close) waiter.rejectOnEvent(this, _events2.Events.AndroidDevice.Close, () => new _errors.TargetClosedError());
...
class AndroidWebView extends _events.EventEmitter {
